...
function addRole() {
    inquirer
        ...
        .then((data) => {
            db.query(`INSERT INTO roles ( title, department, salary, d_id)
            VALUES (?,?,?,?)`,
        ...
        inquirer.prompt([
            {
                ...
                choices: db.query('SELECT first_name, last_name, title FROM employees;')
            },
            {
                type: 'list',
                name: 'title',
...
module.exports = { viewRoles, addRole, upRole }
